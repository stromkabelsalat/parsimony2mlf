...
public class QuirksReplacerComponent {
	...
	public QuirksReplacerComponent(final ObjectMapper objectMapper, final SeparatorComponent separatorComponent) throws IOException {
		this.separator = separatorComponent.getSeparator();

		final ClassLoader classLoader = QuirksReplacerComponent.class.getClassLoader();

		final URL url = classLoader.getResource("quirks-replacements.json");
