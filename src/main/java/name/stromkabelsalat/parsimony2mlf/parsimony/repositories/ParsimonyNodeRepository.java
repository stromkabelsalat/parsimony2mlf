...
public class ParsimonyNodeRepository {
	...
	public ParsimonyNodeRepository(final ArchivDataRecordRepository archivDataRecordRepository, final NumComponent numComponent) {
	...
	public Optional<ParsimonyNode> findByEpochNumAndBoardNumAndNum(final Short epochNum, final Long boardNum, final Integer num)
	{
		return this
				.parsimonyNodes
				.stream()
