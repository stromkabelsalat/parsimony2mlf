...
public class ParsimonyMessageRepository {
	...
	public ParsimonyMessageRepository(final MessageDataRecordRepository messageDataRecordRepository, final ParsimonyMessageComponent parsimonyMessageComponent) {
