...
public class ValidColorStringRepository {
	...
	public ValidColorStringRepository(final ColorStringDistanceComponent colorStringDistanceComponent, final ApplicationContext applicationContext, final ObjectMapper objectMapper)
			throws IOException {
